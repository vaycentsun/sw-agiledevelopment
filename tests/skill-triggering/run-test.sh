...
echo "  technical-spec.txt               -> sw-technical-spec
  working-plan.txt                 -> sw-working-plan"
echo "  subagent-development.txt         -> sw-subagent-development"
echo "  requesting-code-review.txt       -> sw-code-review"
echo "  receiving-code-review.txt        -> sw-code-review"
echo "  task-verification.txt -> sw-task-verification"
echo "  finishing-branch.txt             -> sw-finishing-branch"
echo "  execute-plan.txt              -> sw-execute-plan"
echo "  parallel-debugging.txt  -> sw-parallel-debugging"
echo ""
